...
items.forEach(function (item) {
  item.addEventListener("click", function (event) {
    ...
    if (event.currentTarget.classList.contains("active")) {
      var _event$currentTarget$ = _slicedToArray(event.currentTarget.children[0].children, 3),
