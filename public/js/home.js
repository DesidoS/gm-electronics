...
items.forEach(function (item) {
  item.addEventListener("click", function (event) {
    ...
    if (event.currentTarget.classList.contains("active")) {
      var _event$currentTarget$ = _slicedToArray(event.currentTarget.children, 4),
        advantageIcon = _event$currentTarget$[2],
        advantageDescription = _event$currentTarget$[3];
...
if (!window.matchMedia("(min-width: 1025px)").matches) {
  ...
  var watchScreenHeight = function watchScreenHeight() {
...
var cookiesOpenPopupButtons = document.querySelectorAll(".cookies__open-popup");
var cookiesClosePopupButton = document.querySelector(".cookies__close-popup");
cookiesOpenPopupButtons.forEach(function (button) {
...
cookiesClosePopupButton.addEventListener("click", function () {
...
var wraps = document.querySelectorAll(".products__item-wrap");
items.forEach(function (item) {
  item.addEventListener("click", function (event) {
    items.forEach(function (el) {
      if (el !== event.currentTarget) {
    ...
    if (currentItem.classList.contains("active")) {
      var _event$currentTarget$ = _slicedToArray(event.currentTarget.firstElementChild.children, 3),
...
/* harmony import */ var _js_advantage_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/advantage.js */ "./resources/js/js/advantage.js");
/* harmony import */ var _js_advantage_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_js_advantage_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _js_popup_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/popup.js */ "./resources/js/js/popup.js");
/* harmony import */ var _js_popup_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_js_popup_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _js_header_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/header.js */ "./resources/js/js/header.js");
...
/* harmony import */ var _js_statistics_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/statistics.js */ "./resources/js/js/statistics.js");
/* harmony import */ var _js_statistics_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_js_statistics_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _js_process_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/process.js */ "./resources/js/js/process.js");
/* harmony import */ var _js_process_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_js_process_js__WEBPACK_IMPORTED_MODULE_8__);
